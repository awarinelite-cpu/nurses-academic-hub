        ...
        <div className="auth-wrap" style={{width:"100%",maxWidth:440,padding:20,margin:"auto"}}>
          <div className="auth-card">
            ...
            <div style={{display:"flex",gap:6,marginBottom:16}}>
              {["student","admin"].map(t=>(
                <div key={t} className={`auth-tab${loginType===t?" active":""}`} style={loginType===t&&t==="admin"?{background:"rgba(124,58,237,.15)",borderColor:"var(--admin)",color:"var(--purple)"}:{}} onClick={()=>setLoginType(t)}>
                  {t==="admin"?"🛡️ Admin":"🎓 Student"}
                </div>
              ))}
            </div>
            {loginType==="admin"&&<div className="admin-tab-hint">🛡️ Admin login — default: <b>admin / admin123</b></div>}
